...
# ryoung note:
# I comment out the PS1 and PROMPT_COMMAND lines because I actually found
# it easier to configure the regex, rather than get it to play nice
# with bash-git-prompt.
#
# Plus, with term-prompt-regex, I can have it detect my iex session
# prompts as well
